...
void ::ARCC::Assembler::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
    ...
    _contentLoaded = true;
    ::Windows::Foundation::Uri^ resourceLocator = ref new ::Windows::Foundation::Uri(L"ms-appx:///Assembler.xaml");
    ::Windows::UI::Xaml::Application::LoadComponent(this, resourceLocator, ::Windows::UI::Xaml::Controls::Primitives::ComponentResourceLocation::Application);
}

void ::ARCC::Assembler::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 32:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::CheckBox^>(this->MIF))->Checked += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::ARCC::Assembler::*)
                    (::Platform::Object^, ::Windows::UI::Xaml::RoutedEventArgs^))&Assembler::Mcheck);
                (safe_cast<::Windows::UI::Xaml::Controls::CheckBox^>(this->MIF))->Unchecked += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::ARCC::Assembler::*)
        ...
        case 33:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::CheckBox^>(this->BIN))->Checked += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::ARCC::Assembler::*)
                    (::Platform::Object^, ::Windows::UI::Xaml::RoutedEventArgs^))&Assembler::Bcheck);
                (safe_cast<::Windows::UI::Xaml::Controls::CheckBox^>(this->BIN))->Unchecked += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::ARCC::Assembler::*)
                    (::Platform::Object^, ::Windows::UI::Xaml::RoutedEventArgs^))&Assembler::BUcheck);
            }
            break;
    }
    _contentLoaded = true;
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::ARCC::Assembler::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
