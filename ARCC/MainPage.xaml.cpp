...
// debug console with standard string
void ARCC::MainPage::debugConsole(std::string in) {
	std::wstring wIn = converter.from_bytes(in);
	String^ stringOut = ref new String(wIn.c_str());
	console->Text += stringOut;
}
// debug console with wstring
void ARCC::MainPage::debugConsole(std::wstring wIn) {

	String^ stringOut = ref new String(wIn.c_str());
	console->Text += stringOut;
}
// debug console with platform string^
void ARCC::MainPage::debugConsole(Platform::String^ pIn) {
	console->Text += pIn;
}
...
void ARCC::MainPage::closeClicked(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e) {
...
void ARCC::MainPage::dynamicRealloc(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void ARCC::MainPage::button_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	closeButVec[lastIndex]->Click += ref new RoutedEventHandler(this, &ARCC::MainPage::closeClicked);
...
void ARCC::MainPage::setGen(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void ARCC::MainPage::loadIx(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void ARCC::MainPage::decodeIx(String^ file) {
...
void ARCC::MainPage::VC(Platform::Object^ sender, Windows::UI::Xaml::Controls::ScrollViewerViewChangedEventArgs^ e)
{
...
void ARCC::MainPage::fillLineNo(int len) {
	LineNoT->Text = "";
...
// callls openIQ
void ARCC::MainPage::LoadIS(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void ARCC::MainPage::openIQ(String^ file, String^ name) {
...
// calls openASM
void ARCC::MainPage::OpenAsmFile(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	// generate a file picker
	FileOpenPicker^ openPicker = ref new FileOpenPicker();
	openPicker->ViewMode = PickerViewMode::List;
...
void ARCC::MainPage::openASM(String^ file) {
...
void ARCC::MainPage::SaveASM(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	// open a location chooser
	auto savePicker = ref new FileSavePicker();
	savePicker->SuggestedStartLocation = Windows::Storage::Pickers::PickerLocationId::DocumentsLibrary;
...
void ARCC::MainPage::generateMC(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	outT->Text = "";
...
void ARCC::MainPage::fileGenOT(string name) {
...
// checkbox handlers
void ARCC::MainPage::Mcheck(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	mifCheck = 1;
}
void ARCC::MainPage::MUcheck(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	mifCheck = 0;
}
void ARCC::MainPage::Bcheck(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	binCheck = 1;
}
void ARCC::MainPage::BUcheck(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	binCheck = 0;
}


void ARCC::MainPage::displayErrorBox(String^ ErrorCode) {
